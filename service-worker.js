// ============================================================
// Service Worker — النسخة النهائية v8
// ============================================================
// الإصلاحات عن v7:
// 1. إصلاح مشكلة الـ offline عند فتح start_url مع ?source=pwa
//    - الآن يبحث بـ ignoreSearch ثم يرجع إلى index.html كـ fallback
//    - منع ظهور صفحة offline.html عند فتح التطبيق وهو مثبت بدون إنترنت
// 2. توحيد Font Awesome إلى 6.4.0 (نفس ما تطلبه الصفحات)
// 3. تخزين جميع URLs الخطوط الفعلية المستخدمة في الصفحات
//    - Tajawal+Fredoka → index, achievements, learn-center, stories
//    - Tajawal+Noto    → listening-system, reading-system, writing-system
//    - Tajawal فقط    → chat, privacy-policy, reading-menu
// ============================================================
